//===============================================================================
//  Register definitions generated by 13781CFG.EXE (Build 38)
...
enum SeSetCommand {
	scRegWrite,   ///< Write 16-bit register value
	scRegWrite32, ///< Write 32-bit register value
	scDelayOff,   ///< LCD Panel power OFF delay, in microseconds
	scDelayOn,	///< LCD Panel power ON delay, in microseconds
	scPllWait,	///< Wait for PLL, maximum time in microseconds
};
